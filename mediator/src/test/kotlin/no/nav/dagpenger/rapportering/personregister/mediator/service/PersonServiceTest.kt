...
class PersonServiceTest {
    ...
    @Test
    fun `kan hente ident ved bruk av personId`() {
        val personId = 1L
        every { personRepository.hentPersonIdent(eq(personId)) } returns ident

        personService.hentPersonIdent(personId) shouldBe ident
    }
