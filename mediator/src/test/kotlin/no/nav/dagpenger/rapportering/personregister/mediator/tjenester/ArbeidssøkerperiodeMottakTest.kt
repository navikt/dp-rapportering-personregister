...
class ArbeidssøkerperiodeMottakTest {
    ...
    @Test
    fun `skal håndtere arbeidssøkerperiode-melding`() = runBlocking {
        val arbeidssøkerperiodeMottak = ArbeidssøkerperiodeMottak(
    ...
    @Test
    fun `skal håndtere ugyldig arbeidssøkerperiode-melding`() = runBlocking {
        val arbeidssøkerperiodeMottak = ArbeidssøkerperiodeMottak(
            kafkaConsumer = testConsumer,
            personstatusMediator = personstatusMediator
        ).apply { stream() }
