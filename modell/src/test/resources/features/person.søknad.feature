#language: no
Egenskap: Person
  Brukere som søker om dagpenger eller får dagpengervedtak skal få oppdatert status
  ...
  Scenariomal: Vedtak om innvilgelse gir status "INNVILGET"
    Gitt en person søkt om dagpenger den "<søknadsdato>" med søknadId "<søknadId>"
